...
const SOLUTIONS = [
  {
    ...
    description:
      "65 deterministic rules + ML models check capability leakage, ownership bugs, hot-potato misuse, unsafe upgrades, signer checks, and overflow risk — no audit team required.",
  },
  {
  ...
  },
  {
    ...
    description:
      "The report is encrypted with Seal, stored permanently on Walrus, and linked on-chain via MVR — the audit becomes part of the contract's permanent identity.",
  },
];
