    ...
    <header className="absolute top-0 left-0 right-0 z-50 bg-transparent">
      <div className="w-full px-8 md:px-12 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8 text-sm text-[var(--text-secondary)] font-medium items-center">
          ...
          <a href="https://movelens.mintlify.io/mcp/setup" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-primary)] transition-all flex items-center gap-0.5">MCP <span className="opacity-60">↓</span></a>
        </nav>
