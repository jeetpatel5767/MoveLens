const CARDS = [
  {
    name: "Seal",
    img: "/seal.png",
    description: "Encrypts the report. The owner gets the private draft first.",
  },
  {
    name: "Walrus",
    img: "/wal.png",
    description: "Stores it permanently — tamper-evident and content-addressed.",
  },
  {
    name: "MVR",
    img: null,
    description: "Links the report to your package's on-chain identity permanently.",
  },
  {
    name: "Sui",
    img: "/sui.png",
    description: "The chain everything lives on — public and outside MoveLens's control.",
  },
];
    ...
    >
      <div className="flex items-center justify-center flex-1">
        {card.img ? (
          ...
          <div className="font-display font-extrabold text-[36px] leading-none text-white tracking-[-0.02em]">
            MVR
          </div>
        )}
      </div>
    ...
    <section className="relative w-full bg-black px-6 pt-8 sm:pt-10 pb-16 sm:pb-20">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16">
          ...
          {/* Right — alternating asymmetric rows */}
          <div className="flex-1 flex flex-col gap-4">

            {/* Row 1: bigger LEFT (3fr), smaller RIGHT (2fr) */}
            <div className="grid gap-4" style={{ gridTemplateColumns: "3fr 2fr" }}>
              <TrustCard card={CARDS[0]} />
              <TrustCard card={CARDS[1]} />
            </div>

            {/* Row 2: smaller LEFT (2fr), bigger RIGHT (3fr) */}
