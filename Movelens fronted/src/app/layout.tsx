  ...
  return (
    <html lang="en" className="h-full antialiased">
      <head>
        ...
        <link href="https://api.fontshare.com/v2/css?f[]=cabinet-grotesk@100,200,300,400,500,700,800,900&f[]=switzer@100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet" />
